...
public class RegistrationResponseProcessingTest {
    ...
    public void serverDataValidation() throws Exception {
        ...
        response.getOperationHeader().setServerData(prepareServerData());
    ...
    public void serverDataValidation_fails_withInvalidVersion() throws Exception {
        RegistrationResponseProcessing rrp = new RegistrationResponseProcessing(5 * 60 * 1000, new NotaryImpl());
        RegistrationResponse response = getResponse();
        response.getOperationHeader().setServerData(prepareServerData());
        response.getOperationHeader().getProtocolVersion().setMajor(5);

        rrp.processResponse(response);
    }
    ...
    private String getTestRegResponse() {
        return "{\"assertions\":[{\"assertion\":\"AT7uAgM"
                + "-sQALLgkAQUJDRCNBQkNEDi4HAAABAQEAAAEKLiAA9tBzZC64ecgVQBGSQb5QtEIPC8-Vav4HsHLZDflLaugJLiAAZMCPn92yHv1Ip"
                + "-iCiBb6i4ADq6ZOv569KFQCvYSJfNgNLggAAQAAAAEAAAAMLkEABJsvEtUsVKh7tmYHhJ2FBm3kHU"
                +
                "-OCdWiUYVijgYa81MfkjQ1z6UiHbKP9_nRzIN9anprHqDGcR6q7O20q_yctZAHPjUCBi5AACv8L7YlRMx10gPnszGO6rLFqZFmmRkhtV0TIWuWqYxd1jO0wxam7i5qdEa19u4sfpHFZ9RGI_-SnEwCQYHKoZIzj0EAQNJADBGAiEAzAQujXnSS9AIAh6lGz6ydypLVTsTnBzqGJ4ypIqy_qUCIQCFsuOEGcRV-o4GHPBph_VMrG3NpYh2GKPjsAim_cSNmQ\",\"assertionScheme\":\"UAFV1TLV\"}],\"finalChallengeParams\":\"eyJhcHBJRCI6Imh0dHBzOi8vdWFmLXRlc3QtMS5ub2tub2t0ZXN0LmNvbTo4NDQzL1NhbXBsZUFwcC91YWYvZmFjZXRzIiwiY2hhbGxlbmdlIjoiSDlpVzl5QTlhQVhGX2xlbFFvaV9EaFVrNTE0QWQ4VHF2MHpDbkNxS0RwbyIsImNoYW5uZWxCaW5kaW5nIjp7fSwiZmFjZXRJRCI6ImNvbS5ub2tub2suYW5kcm9pZC5zYW1wbGVhcHAifQ\",\"operationHeader\":{\"appId\":\"https://uaf-test-1.noknoktest.com:8443/SampleApp/uaf/facets\",\"operation\":\"REGISTRATION\",\"serverData\":\"IjycjPZYiWMaQ1tKLrJROiXQHmYG0tSSYGjP5mgjsDaM17RQgq0dl3NNDDTx9d-aSR_6hGgclrU2F2Yj-12S67v5VmQHj4eWVseLulHdpk2v_hHtKSvv_DFqL4n2IiUY6XZWVbOnvg\",\"protocolVersion\":{\"major\":1,\"minor\":0}}}";
    }

    private String getTestRegResponse2() {
        return "{\"assertions\":[{\"assertion\":\"AT5HAwM-ywALLgkAMTM4QSM0MjAyDi4HAAEAAQIAAQEKLiAA8y7kunvd44"
                + "-a9X2uorVkBXY9O2cBjq9eoMJ_dMHp9N8JLiAAzsfjhbCwYi_w-zHTiFvJj7cv"
                +
                "-siLlds5DaqhxS9Wt9YNLggAAAAAAAAAAAAMLlsAMFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEYF90PjVZI3r6boxoZU7coML95fq"
                + "-aaBMiBlCtD1OakDWlyfOvy3XNGq0VgGi07907M7nbYQk4X7DxvRNw32i_gc"
                + "-dAIGLkcAMEUCIA5ini_jQ_LbeISWDTjXySWZtFq5b5fJpd-ZPttbhfDtAiEA3n2RnSN"
                +
                "-_MKXwdtfkbsFR2kvtnSlnesBJdF5acPuUBswKcnQhAHDv7Btf9LHQppfTOrSl4ndkLasRfmoTANz7nEGM3RzTAJBgcqhkjOPQQBA0kAMEYCIQDqU8DxhlwEe4gfyJDVTyWNdbbzOuluMHk3j31DHYsyQgIhANkuIVsk9QcaiD-ZR-RDoGmUEIj97TUYCSiSTAXgACuW\",\"assertionScheme\":\"UAFV1TLV\"}],\"finalChallengeParams\":\"eyJhcHBJRCI6Imh0dHBzOi8vdWFmLXRlc3QtMS5ub2tub2t0ZXN0LmNvbTo4NDQzL1NhbXBsZUFwcC91YWYvZmFjZXRzIiwiY2hhbGxlbmdlIjoiSDlpVzl5QTlhQVhGX2xlbFFvaV9EaFVrNTE0QWQ4VHF2MHpDbkNxS0RwbyIsImNoYW5uZWxCaW5kaW5nIjp7fSwiZmFjZXRJRCI6ImNvbS5ub2tub2suYW5kcm9pZC5zYW1wbGVhcHAifQ\",\"operationHeader\":{\"appId\":\"https://uaf-test-1.noknoktest.com:8443/SampleApp/uaf/facets\",\"operation\":\"REGISTRATION\",\"serverData\":\"IjycjPZYiWMaQ1tKLrJROiXQHmYG0tSSYGjP5mgjsDaM17RQgq0dl3NNDDTx9d-aSR_6hGgclrU2F2Yj-12S67v5VmQHj4eWVseLulHdpk2v_hHtKSvv_DFqL4n2IiUY6XZWVbOnvg\",\"protocolVersion\":{\"major\":1,\"minor\":0}}}";
