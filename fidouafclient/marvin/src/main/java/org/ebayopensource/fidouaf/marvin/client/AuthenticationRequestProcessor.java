...
public class AuthenticationRequestProcessor {
	...
	public AuthenticationResponse processRequest(AuthenticationRequest request) throws Exception{
	...
	private void setAssertions(AuthenticationResponse response, AuthAssertionBuilder builder) throws Exception{
